...
print(paste0("not matched:", list[which(is.na(index)), ])) #all species listed here were not found on the official list. If the official list is comprehensive, check these for spelling and potential taxonomy changes and rerun if necessary
...
matches <- cbind(manual_check_recommended = m, matches)
